      ...
      <div className="red col-lg-12 col-md-12 col-12 d-flex flex-wrap py-3 blog__box">
        ...
        <div className="mt-3 red col-lg-7 col-md-7 col-12 post__box">
          ...
          {this.state.blogContent &&
            this.state.blogContent.map((article) => (
              <div>
                <h4>{article.title}</h4>
          ...
          {/* {子留言區塊} */}
          <div className="child__cmmt__box green py-3">
            {this.state.child_cmmt &&
              this.state.child_cmmt.map((child_cmmt, index) => (
                  ...
                  <div className="d-flex justify-content-between">
                    <div className="d-flex">
                      <div className="col-lg-2 col-md-2 col-4 px-0">
                        <img
                          className="img-fluid"
                          src="https://megapx-assets.dcard.tw/61e253d5-a979-4acd-a81f-a9a49ead4f2f/full"
                          alt=""
                        />
                      </div>
                      <div className="ml-3">
                        <p className="mb-0">{child_cmmt.nickname}</p>
                        <span className="child__cmmt__floor">
                          {"B" + ++index}
                        </span>
                        <span className="child__cmmt__floor">
                          {" " + changeDate(child_cmmt.time)}
                        </span>
                      </div>
                    </div>
                    <div>
                      <i
                        className={
                          "fas fa-heart " +
                          (child_cmmt.color ? "heart-red" : "heart-grey")
                        }
